package net.gestion.pgpu.daoImplement;

import net.gestion.pgpu.dao.DAOTemplete;
import net.gestion.pgpu.domaine.personnel.PersonnelModel;
import net.gestion.pgpu.mapper.PersonnelMapper;
...
//                .usingGeneratedKeyColumns("IDagent");
    ...
    public boolean create(PersonnelModel obj) {
        try {
            String sql = "Insert into personnel(nometprenom,matricul,nni) values (?, ?, ?)";
