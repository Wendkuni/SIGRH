package net.gestion.pgcongeabsence.daoImplement.personnel;


import net.gestion.pgcongeabsence.common.constant.TypeEducation;
import net.gestion.pgcongeabsence.dao.DAOTemplete;
import net.gestion.pgcongeabsence.domains.personnel.PersonnelModel;
import net.gestion.pgcongeabsence.mappers.personnel.PersonnelMapper;
